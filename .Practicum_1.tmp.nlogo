...
to Lopen
  ...
  if any? turtles with [ patch-ahead 1 = nobody ] [if (Heatmap) [kleuren] stop] ;; stopt als turtle aan de rand is
...
Door in commando's in te geven in de vorm van R of L vertoont de ant bepaald gedrag. Staat er op de 1e plek in de string een L dan gaat de ant naar links in state 1, staat er een R op de 2e plek dan gaat de ant naar rechts als hij een patch met state 2 aantreft enz. Dit gaat door tot maximaal 12. Bij het verlaten van de patch verhoogt de state met 1. Omdat de states gekoppeld zijn aan kleuren verandert hiermee ook de kleur. De gebruiker kan ook kiezen uit een staandaard aantal opties van LR strings om bepaalde vormen te krijgen.
